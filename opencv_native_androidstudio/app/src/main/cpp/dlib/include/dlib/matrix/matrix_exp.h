...
// ----------------------------------------------------------------------------------------
    ...
    class matrix_exp_iterator
            : public std::iterator<std::forward_iterator_tag, typename matrix_traits<EXP>::type> {
    ...
    public:
        ...
        bool operator==(const matrix_exp_iterator &itr) const { return r == itr.r && c == itr.c; }

        bool operator!=(const matrix_exp_iterator &itr) const { return !(*this == itr); }
