...
namespace dlib {
    ...
    private:
        ...
        conditioning_class_kernel_4(
                conditioning_class_kernel_4<alphabet_size, pool_size, mem_manager> &);        // copy constructor
        conditioning_class_kernel_4 &operator=(
                conditioning_class_kernel_4<alphabet_size, pool_size, mem_manager> &);    // assignment operator
